...
latex_documents = [
    (master_doc, 'knoblin.tex', u'knoblin Documentation',
     u'Author', 'manual'),
]
...
man_pages = [
    (master_doc, 'knoblin', u'knoblin Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'knoblin', u'knoblin Documentation',
     author, 'knoblin', 'One line description of project.',
     'Miscellaneous'),
]
